...
import { Scope, ScopeManager, Variable } from "../..";
export declare class ExportDefaultVirtualScope implements VirtualScope {
    readonly id: number;
    ...
    constructor(id: number, contentType: VScopeContentType, declaration: ESTree.Node, isChildrenDependent?: boolean);
