...
let detachAndroidAsync = (() => {
  var _ref4 = _asyncToGenerator(function* (context, expoViewUrl) {
    ...
    if (_process.default.env.EXPO_VIEW_DIR) {
      // Only for testing
      yield (_AndroidShellApp || _load_AndroidShellApp()).copyInitialShellAppFilesAsync(_path.default.join(_process.default.env.EXPO_VIEW_DIR, 'android'), androidProjectDirectory, true);
    } else {
...
let bundleAssetsAsync = exports.bundleAssetsAsync = (() => {
  var _ref12 = _asyncToGenerator(function* (projectDir, args) {
    ...
    yield (_AssetBundle || _load_AssetBundle()).bundleAsync(manifest.bundledAssets, args.dest);
  });
