...
exports.updateTurtleVersionAsync = updateTurtleVersionAsync;
...
async function updateTurtleVersionAsync(sdkVersion, platform) {
  const platforms = platform === 'both' ? ['android', 'ios'] : [platform];
  const versions = await Versions.versionsAsync();
  platforms.forEach(p => _lodash.default.set(versions, ['turtleSdkVersions', p], sdkVersion));
  await Versions.setVersionsAsync(versions);
}
