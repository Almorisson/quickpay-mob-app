...
var _ExponentTools = require("../detach/ExponentTools");

var _Logger = _interopRequireDefault(require("../detach/Logger"));
...
async function _resizeImageWithSipsAsync(iconSizePx, iconFilename, destinationIconPath) {
  return (0, _ExponentTools.spawnAsyncThrowError)('sips', ['-Z', iconSizePx, iconFilename], {
