...
async function readAsync(projectRoot) {
  ...
  _lodash.default.defaults(projectSettings, projectSettingsDefaults);
...
async function setAsync(projectRoot, json) {
  try {
    ...
    return await projectSettingsJsonFile(projectRoot, projectSettingsFile).writeAsync(_lodash.default.defaults(json, projectSettingsDefaults));
  }
}
