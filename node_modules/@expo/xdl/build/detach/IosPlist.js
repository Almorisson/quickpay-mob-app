...
async function cleanBackupAsync(plistPath, plistName, restoreOriginal = true) {
  ...
  if (restoreOriginal) {
    await (0, _ExponentTools.spawnAsyncThrowError)('/bin/cp', [`${configPlistName}.bak`, configPlistName]);
  }

  await (0, _ExponentTools.spawnAsyncThrowError)('/bin/rm', [`${configPlistName}.bak`]);
  await (0, _ExponentTools.spawnAsyncThrowError)('/bin/rm', [configFilename]);
}
