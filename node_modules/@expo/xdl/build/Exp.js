...
var _Convert = _interopRequireDefault(require("./project/Convert"));
...
async function clearXDLCacheAsync() {
  ...
  _rimraf.default.sync(_path.default.join(dotExpoHomeDirectory, 'ios-simulator-app-cache'));

  _rimraf.default.sync(_path.default.join(dotExpoHomeDirectory, 'android-apk-cache'));

  _rimraf.default.sync(_path.default.join(dotExpoHomeDirectory, 'starter-app-cache'));
