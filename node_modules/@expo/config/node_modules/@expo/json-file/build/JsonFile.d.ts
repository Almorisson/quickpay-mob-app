...
export default class JsonFile<TJSONObject extends JSONObject> {
    ...
    mergeAsync(sources: TJSONObject | Array<TJSONObject>, options?: Options<TJSONObject>): Promise<JSONObject>;
    deleteKeyAsync(key: string, options?: Options<TJSONObject>): Promise<TJSONObject>;
    deleteKeysAsync(keys: Array<string>, options?: Options<TJSONObject>): Promise<TJSONObject>;
...
declare function mergeAsync<TJSONObject extends JSONObject>(file: string, sources: Array<TJSONObject> | TJSONObject, options?: Options<TJSONObject>): Promise<TJSONObject>;
...
declare function deleteKeysAsync<TJSONObject extends JSONObject>(file: string, keys: Array<string>, options?: Options<TJSONObject>): Promise<TJSONObject>;
